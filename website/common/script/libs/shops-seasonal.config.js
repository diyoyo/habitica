...
export default {
  ...
  availableSpells: CURRENT_EVENT && moment().isBetween('2024-02-18T08:00-04:00', CURRENT_EVENT.end)
    ? [
      'shinySeed',
    ]
    : [],

  availableQuests: CURRENT_EVENT && moment().isBetween('2024-02-18T08:00-04:00', CURRENT_EVENT.end)
    ? [
      'egg',
    ]
    : [],
